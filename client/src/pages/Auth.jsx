    ...
    <div className="min-h-screen overflow-hidden bg-white text-black px-8">
      ...
      >
        ...
        <p className="text-sm text-gray-300 mt-1">
          AI-powered exam-orianted notes & revision
        </p>
      </motion.header>
      ...
      <main className="max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          <p
            className="mt-6 max-w-xl text-lg
                     bg-gradient-to-br from-gray-700 via-gray-500/80 bg-clip-text text-transparent"
          >
          ...
          <p className="mt-4 text-sm">
            Start with 100 FREE Credit &bull; Upgrade anytime &bull; Instant
            Access
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          <Feature
            ...
            description="Start with 100 Free Credits to generate notes without paying."
          />
          <Feature
            icon="📝"
            title="Exam Notes"
            description="High-yeld, revision-ready exam orianted notes."
          />
          <Feature
            icon="📂"
