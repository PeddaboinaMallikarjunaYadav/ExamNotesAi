    ...
    <div className="min-h-screen bg-gray-100 px-6 py-10 relative">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        <PricingCard
          ...
          amount={100}
          credit="75 Credits"
          description="Prefect for quick revisions"
          features={[
            "Generate AI Notes",
        ...
        <PricingCard
          ...
          amount={200}
          credit="150 Credits"
          description="Best value for studends"
          features={[
            "All Starters features",
            "More credits per ₹",
...
function PricingCard({
  ...
  return (
    <motion.div
      whileHover={{ y: -4 }}
      onClick={() =>
        setSelectedPrice((prev) => (prev === amount ? null : amount))
      }
      className={`
    ...
    >
      ...
      <div className="mt-4">
        ...
        <p className="text-sm text-indigo-600">{credit}</p>
      </div>
      ...
      <ul className="mt-5 space-y-2 text-sm tex-gray-600">
        {features.map((f, i) => (
