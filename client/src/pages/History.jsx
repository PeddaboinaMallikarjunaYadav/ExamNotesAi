    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8">
      <motion.header
        ...
        className="mb-10 
          ...
          px-8 py-6
          items-start flex justify-between 
      ...
      <div className="grid grid-col-1 lg:grid-cols-4 gap-6">
        <AnimatePresence>
          ...
          top-0 left-0 z-50 lg:z-auto w-72
           lg:w-auto h-full lg:h-[75vh] lg:cols-span-1 
           bg-black/90 lg:bg-black/80
           rounded-3xl 
           backdrop-blur-xl border 
           border-white/10 shadow-[0_20px_45px_rgba(0,0,0,0.6)] 
          p-5 overflow-y-auto"
            >
              <button
                  ...
                  {topic.map((t, i) => (
                    ...
                    >
                      ...
                      <div className="flex gap-3 mt-2 text-xs text-gray-300">
                        {t.revisionMode && <span>⚡ Revison</span>}
        ...
        >
          {loading && (
            <h1 className="text-center text-gray-500">Loading Notes......</h1>
          )}
