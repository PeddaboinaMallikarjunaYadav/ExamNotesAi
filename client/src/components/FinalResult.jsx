...
const markDownComponent = {
  ...
  ul: ({ children }) => (
    <ul className="list-disc ml-6 space-y-2 text-gray-700 marker:text-indigo-500">
      {children}
    </ul>
  ),
    ...
    <div className="mt-6 p-3 space-y-10 bg-white">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex gap-3">
          ...
          <button className="px-4 py-2 rounded-lg cursor-pointer text-sm font-medium bg-indigo-600 text-white hover:bg-indigo-700">
            ⬇️ Download-PDF
          </button>
        </div>
      </div>
      ...
      {result.diagram?.data && (
        <section>
          ...
          <p className="mt-3 text-xs text-gray-500 italic">
            ℹ️ If you need this diagram for future references or revision,
            please take a screenshort of it.
          </p>
        </section>
      )}
      ...
      {result.charts?.length > 0 && (
        <section>
          ...
          <p className="mt-3 text-xs text-gray-500 italic">
            ℹ️ If you need this chart for future references or revision, please
            take a screenshort of it.
          </p>
        </section>
      )}
